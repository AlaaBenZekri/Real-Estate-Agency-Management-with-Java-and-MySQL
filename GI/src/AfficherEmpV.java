...
public class AfficherEmpV extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AfficherEmpV frame = new AfficherEmpV();
	...
	private void mjCompte(ActionEvent e) {
		try {
			...
			String sql="UPDATE employevisite SET Nom= ?, Prenom= ?, NumRue= ?, Rue= ?, CodePostale= ?, Localite= ?, NumTel= ? WHERE idEmp= ? ;";
