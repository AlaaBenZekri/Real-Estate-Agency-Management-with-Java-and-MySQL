...
public class AjoutClient1 extends JFrame {
	...
	public AjoutClient1() {
		...
		lblAdresseEmail.setBounds(273, 168, 108, 21);
	...
	public void insererClient(ActionEvent e) {
		try {
			...
			if (n==0) {
				sql="INSERT INTO client(Nom, Prenom, NumRue, Rue, CodePostale, Localite, NumTel) Values(?,?,?,?,?,?,?);";
				...
				CreerVisite m=new CreerVisite();
				m.setVisible(true);
				sql="SELECT idClient FROM client where Nom='"+textNom.getText()+"' and Prenom='"+textPre.getText()+"';";
